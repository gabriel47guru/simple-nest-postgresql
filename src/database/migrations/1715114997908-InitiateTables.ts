...
export class InitiateTables1715114997908 implements MigrationInterface {
  name = 'InitiateTables1715114997908';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "jobs" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "minHourlyPay" integer NOT NULL, "maxHourlyPay" integer NOT NULL, "employmentTypes" "public"."jobs_employmenttypes_enum" array NOT NULL DEFAULT '{}', "videoUrl" character varying NOT NULL, "businessId" integer, CONSTRAINT "PK_cf0a6c42b72fcc7f7c237def345" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
